...
Widget item(achievement1 model, context) {
  return Stack(
    children: [
      Container(
                  ...
                  children: [
                    ...
                    Container(child: Row(
                      ...
                      child: Image(
                        height: 50,
                        width: 50,
                        image: NetworkImage('https://cdn-icons-png.flaticon.com/128/216/216863.png'))
                    ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              child: Text('Politeknik Piksi Ganesha crowned champions for Novice First Best Speaker in Asian English Olympics 2018',
                                style: TextStyle(
                                  fontSize: 20,
                            ...
                            SizedBox(height: 20,),
                             ...
                             Container(
                              ...
                              child: Image(
                                fit: BoxFit.cover,
                                image: NetworkImage('https://cdn-icons-png.flaticon.com/128/4048/4048675.png')),
                             ),
                                      ...
                                      Text('Politeknik Piksi Ganesha Debate Society has made us very proud to be crowned champions of the Asian English Olympics (AEO) in the debate division. This is a much-coveted win at the AEO hosted by BINUS University in Indonesia and attended by several prominent institutions in Asia.',
                                      style: TextStyle(
                                        fontSize: 15,
