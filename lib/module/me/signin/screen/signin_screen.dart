...
class SigninScreen extends StatelessWidget {
                    ...
                    child: Center(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          button(contextsignin, controller),
                          // Container(
  ...
  Widget button(context, SigninController controller) {
    return InkWell(
      onTap: () {
        controller.postLoginUser();
      },
      child: Container(
        padding: const EdgeInsets.only(right: 30, left: 30, bottom: 7, top: 7),
        decoration: BoxDecoration(
  ...
  Widget button2(title, SigninController controller) {
    return InkWell(
      onTap: () {},
